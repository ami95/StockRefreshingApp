...
*/
package com.example.homer.myapplication.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.example.homer.myapplication.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        // Note: Ensure that the google-services.json has read
        // permissions set.
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/WEB-INF/google-services.json"))
                .setDatabaseUrl("https://stockrefreshingappfirebase.firebaseio.com/")
                .build();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // loading http://stockrefreshingappfirebase.appspot.com/send-email in your browser.
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@stockrefreshingappfirebase.appspotmail.com",
                            "Todo Reminder"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("mihaiadrian1995@gmail.com", "Recipient"));
